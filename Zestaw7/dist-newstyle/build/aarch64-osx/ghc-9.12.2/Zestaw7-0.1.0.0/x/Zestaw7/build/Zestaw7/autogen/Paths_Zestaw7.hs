...
-- at runtime using the environment variable Zestaw7_bindir.
...
-- environment variable Zestaw7_libdir.
...
-- using the environment variable Zestaw7_dynlibdir.
...
-- runtime using the environment variable Zestaw7_datadir.
...
-- using the environment variable Zestaw7_sysconfdir.
...
libdir     = "/Users/maciejserafin/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace/Zestaw7-0.1.0.0-inplace-Zestaw7"
dynlibdir  = "/Users/maciejserafin/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace"
datadir    = "/Users/maciejserafin/.cabal/share/aarch64-osx-ghc-9.12.2-inplace/Zestaw7-0.1.0.0"
libexecdir = "/Users/maciejserafin/.cabal/libexec/aarch64-osx-ghc-9.12.2-inplace/Zestaw7-0.1.0.0"
sysconfdir = "/Users/maciejserafin/.cabal/etc"

getBinDir     = catchIO (getEnv "Zestaw7_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "Zestaw7_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "Zestaw7_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "Zestaw7_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "Zestaw7_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "Zestaw7_sysconfdir") (\_ -> return sysconfdir)
