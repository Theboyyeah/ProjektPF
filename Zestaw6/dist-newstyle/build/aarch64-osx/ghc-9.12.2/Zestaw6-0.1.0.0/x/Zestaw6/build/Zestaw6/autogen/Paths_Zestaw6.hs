...
-- at runtime using the environment variable Zestaw6_bindir.
...
-- environment variable Zestaw6_libdir.
...
-- using the environment variable Zestaw6_dynlibdir.
...
-- runtime using the environment variable Zestaw6_datadir.
...
-- using the environment variable Zestaw6_sysconfdir.
...
bindir     = "/Users/maciejserafin/.cabal/bin"
libdir     = "/Users/maciejserafin/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace/Zestaw6-0.1.0.0-inplace-Zestaw6"
dynlibdir  = "/Users/maciejserafin/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace"
datadir    = "/Users/maciejserafin/.cabal/share/aarch64-osx-ghc-9.12.2-inplace/Zestaw6-0.1.0.0"
libexecdir = "/Users/maciejserafin/.cabal/libexec/aarch64-osx-ghc-9.12.2-inplace/Zestaw6-0.1.0.0"
sysconfdir = "/Users/maciejserafin/.cabal/etc"

getBinDir     = catchIO (getEnv "Zestaw6_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "Zestaw6_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "Zestaw6_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "Zestaw6_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "Zestaw6_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "Zestaw6_sysconfdir") (\_ -> return sysconfdir)
