...
-- at runtime using the environment variable Zestaw8_bindir.
...
-- environment variable Zestaw8_libdir.
...
-- using the environment variable Zestaw8_dynlibdir.
...
-- runtime using the environment variable Zestaw8_datadir.
...
-- using the environment variable Zestaw8_sysconfdir.
...
libdir     = "/Users/maciejserafin/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace/Zestaw8-0.1.0.0-inplace-Zestaw8"
dynlibdir  = "/Users/maciejserafin/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace"
datadir    = "/Users/maciejserafin/.cabal/share/aarch64-osx-ghc-9.12.2-inplace/Zestaw8-0.1.0.0"
libexecdir = "/Users/maciejserafin/.cabal/libexec/aarch64-osx-ghc-9.12.2-inplace/Zestaw8-0.1.0.0"
sysconfdir = "/Users/maciejserafin/.cabal/etc"

getBinDir     = catchIO (getEnv "Zestaw8_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "Zestaw8_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "Zestaw8_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "Zestaw8_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "Zestaw8_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "Zestaw8_sysconfdir") (\_ -> return sysconfdir)
